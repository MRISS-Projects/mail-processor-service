...
[![GitHub](https://img.shields.io/github/license/MRISS-Projects/mail-processor-service?color=blue&label=License)](https://www.apache.org/licenses/LICENSE-2.0.txt) [![Build Status](https://jenkins.mriss.org/jenkins/buildStatus/icon?job=MailProcessingService-Snapshot)](https://jenkins.mriss.org/jenkins/job/MailProcessingService-Snapshot/)
